  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'bg-banner-mecanismos-lg': 'url(/images/mecanismos-participacion/participacion-ciudadana.png)',
        'bg-banner-mecanismos-sm': 'url(/images/mecanismos-participacion/participacion-ciudadana-movil.png)',
        'bg-banner-mecanismos-descarga-lg': 'url(/images/mecanismos-participacion/descarga-datos-participacion.png)',
        'bg-banner-mecanismos-descarga-sm': 'url(/images/mecanismos-participacion/descarga-datos-participacion-movil.png)',
      },
    },
  },
  variants: {
